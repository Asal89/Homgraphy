...
UeyeOpencvCam::UeyeOpencvCam(int wdth, int heigh, int cameraID) {
	...
	retInt = is_SetExternalTrigger (hCam,IS_SET_TRIGGER_LO_HI);  // trigger mode  IS_SET_TRIGGER_LO_HI IS_SET_TRIGGER_OFF
	if (retInt != IS_SUCCESS) {							
		throw UeyeOpenCVException(hCam, retInt);
	}
